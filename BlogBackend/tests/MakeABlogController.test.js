...
describe('MakeABlogController Tests', () => {
    ...
    describe('GET /api/createblog/makeblog/all', () => {
        it('should fetch all blogs successfully', async () => {
            const mockBlogs = [
                { id: 1, title: 'Blog 1', content: 'Content 1', email: 'author1@example.com' },
                { id: 2, title: 'Blog 2', content: 'Content 2', email: 'author2@example.com' },
            ];
    ...
    describe('DELETE /api/createblog/makeblog/admin/delete/:id', () => {
        it('should delete a blog successfully', async () => {
            const mockDeletedBlog = { id: 1, title: 'Blog 1', content: 'Content 1', email: 'author1@example.com' };

            pool.query.mockResolvedValueOnce({ rows: [mockDeletedBlog] }); // Mock the database response
            ...
            expect(response.status).toBe(200);
            expect(response.body.message).toBe('Blog deleted successfully');
            expect(response.body.deletedBlog).toEqual(mockDeletedBlog);
        });
    ...
    describe('GET /api/createblog/yourblog', () => {
        it('should fetch user blogs successfully', async () => {
            const mockUserBlogs = [
                { id: 1, title: 'User  Blog 1', content: 'User  Content 1', email: 'author@example.com' },
                { id: 2, title: 'User  Blog 2', content: 'User  Content 2', email: 'author@example.com' },
            ];
